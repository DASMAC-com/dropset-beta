...
\PROCEDURE{REGISTER-MARKET}{$input, insn, n\_accounts, insn\_len$}
  ...
  \ENDIF
  \COMMENT{Populate CreateAccount CPI instruction data owner field before advancing.}
  \STATE $frame.create\_account\_data.owner = input.market.address$
  ...
  \STATE $frame.pda\_seeds.bump.addr = \&frame.bump$
