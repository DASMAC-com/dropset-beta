...
\begin{algorithmic}
  ...
  \REQUIRE *frame.system\_program\_id = \texttt{RegisterMarketAccounts::SystemProgram}
...
\FUNCTION{INIT-VAULT}{acct, frame}
  ...
  \STATE frame.create\_account\_data.lamports = acct\_size $\times$ frame.lamports\_per\_byte
  ...
  \STATE frame.cpi[0].info.data\_len = input.user.data\_len
